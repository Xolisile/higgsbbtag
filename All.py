...
pt_hist_Zprime=TH1F('jet_pt_hist','pt histogram;jet p_{T} [GeV/c]; Events',50,0,3000)
...
prunedmass_hist_Zprime=TH1F('prunedmass_hist','prunedmass;prunedmass; ',170,-50,200)
softdropmass_hist_Zprime=TH1F('softdropmass_hist','softdropmass;softdropmass; ',50,-50,200)
prunedmass_hist1_Zprime=TH1F('prunedmass_hist1','prunedmass;prunedmass_Cut1; ',170,-50,200)
softdropmass_hist1_Zprime=TH1F('softdropmass_hist1','softdropmass;softdropmass_Cut1; ',50,-50,200)
prunedmass_hist2_Zprime=TH1F('prunedmass_hist2','prunedmass;prunedmass_Cut2; ',170,-50,200)
softdropmass_hist2_Zprime=TH1F('softdropmass_hist2','softdropmass;softdropmass_Cut2; ',50,-50,200)
prunedmass_hist3_Zprime=TH1F('prunedmass_hist3','prunedmass;prunedmass_Cut3; ',170,-50,200)
softdropmass_hist3_Zprime=TH1F('softdropmass_hist3','softdropmass;softdropmass_Cut3; ',50,-50,200)
prunedmass_hist4_Zprime=TH1F('prunedmass_hist4','prunedmass;prunedmass_Cut4; ',170,-50,200)
softdropmass_hist4_Zprime=TH1F('softdropmass_hist4','softdropmass;softdropmass_Cut4; ',50,-50,200)
prunedmass_hist5_Zprime=TH1F('prunedmass_hist5','prunedmass;prunedmass_Cut5; ',170,-50,200)
softdropmass_hist5_Zprime=TH1F('softdropmass_hist5','softdropmass;softdropmass_Cut5; ',50,-50,200)
prunedmass_hist6_Zprime=TH1F('prunedmass_hist6','prunedmass;prunedmass_Cut6; ',170,-50,200)
softdropmass_hist6_Zprime=TH1F('softdropmass_hist6','softdropmass;softdropmass_Cut6; ',50,-50,200)
...
PFL_hist=TH1F('PFL_hist',';PFLepton_ptrel; ',50,0,200)

change_phi=TH1F('Change_pt_hist','pt histogram;SV-\Delta\phi [GeV/c]; Events',50,0,3000)
change_eta=TH1F('Change_eta_hist','eta histogram;SV-\Delta\eta; Events',50,-2,2)
change_R=TH1F('Change_R_hist','R histogram;SV-\Delta R; Events',50,-2,2)
...
sampleName = "ZprimeToZhToZlephbb_narrow_M-3500_13TeV-madgraph"
sampleNumber = 1
...
for event in range(nEntries):
    ...
    for i in range(getattr(ntuple,"FatJetInfo.nJet")):
        ...
        prunedmass_hist_Zprime.Fill(getattr(ntuple,"FatJetInfo.Jet_massPruned")[i])
        softdropmass_hist_Zprime.Fill(getattr(ntuple,"FatJetInfo.Jet_massSoftDrop")[i])
        #####################################################################
        ...
        ######################################################################
        if(getattr(ntuple,"FatJetInfo.Jet_pt")[i]>200 and abs(getattr(ntuple,"FatJetInfo.Jet_eta")[i])<2.4):
            prunedmass_hist1_Zprime.Fill(getattr(ntuple,"FatJetInfo.Jet_massPruned")[i])
            softdropmass_hist1_Zprime.Fill(getattr(ntuple,"FatJetInfo.Jet_massSoftDrop")[i])
        if(getattr(ntuple,"FatJetInfo.Jet_CombSvx")[i]>0.8):
            prunedmass_hist2_Zprime.Fill(getattr(ntuple,"FatJetInfo.Jet_massPruned")[i])
            softdropmass_hist2_Zprime.Fill(getattr(ntuple,"FatJetInfo.Jet_massSoftDrop")[i])
        if(getattr(ntuple,"FatJetInfo.Jet_pt")[i]>200 and abs(getattr(ntuple,"FatJetInfo.Jet_eta")[i])<2.4 and getattr(ntuple,"FatJetInfo.Jet_CombSvx")[i]>0.8 ):
            prunedmass_hist3_Zprime.Fill(getattr(ntuple,"FatJetInfo.Jet_massPruned")[i])
            softdropmass_hist3_Zprime.Fill(getattr(ntuple,"FatJetInfo.Jet_massSoftDrop")[i])
        ...
        #for b in range(getattr(ntuple,"FatJetInfo.Jet_nbHadrons")):
            #for c in range(getattr(ntuple,"FatJetInfo.Jet_ncHadrons")):
...
prunedmass_hist_Zprime.Write()
prunedmass_hist1_Zprime.Write()
prunedmass_hist2_Zprime.Write()
prunedmass_hist3_Zprime.Write()

softdropmass_hist_Zprime.Write()
softdropmass_hist1_Zprime.Write()
softdropmass_hist2_Zprime.Write()
softdropmass_hist3_Zprime.Write()
